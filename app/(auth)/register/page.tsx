    ...
    <div className="min-h-[80vh] flex items-center justify-center px-6 py-12 bg-background">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl font-heading text-primary-brown mb-2">Tạo tài khoản</h1>
          <p className="text-primary-brown/60">Tham gia chucha.casa để nhận nhiều ưu đãi</p>
        </div>
        ...
        <div className="bg-white/60 backdrop-blur-md rounded-[3rem] p-8 md:p-10 border-2 border-secondary-pink shadow-xl">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-bold mb-2 ml-4 text-primary-brown">Họ và tên</label>
              ...
              {errors.name && (
                <p className="text-red-500 text-xs mt-2 ml-4 font-medium">{errors.name.message}</p>
              )}
            </div>
            ...
            <div>
              <label className="block text-sm font-bold mb-2 ml-4 text-primary-brown">Xác nhận mật khẩu</label>
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-primary-brown/40" size={20} />
                <input
              ...
              {errors.confirmPassword && (
                <p className="text-red-500 text-xs mt-2 ml-4 font-medium">{errors.confirmPassword.message}</p>
              )}
            </div>
